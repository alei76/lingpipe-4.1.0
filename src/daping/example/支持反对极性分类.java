...
public class 支持反对极性分类 {

    File mPolarityDir;
    String[] mCategories;
    DynamicLMClassifier<NGramProcessLM> mClassifier;

    支持反对极性分类(String[] args) {
        System.out.println("\nBASIC POLARITY DEMO");
        mPolarityDir = new File("E:/JAVAProjects/lingpipe-4.1.0/demos/data/review_polarity","txt_sentoken");//1000 positive, 1000 negative full text movie reviews.90%作为训练
