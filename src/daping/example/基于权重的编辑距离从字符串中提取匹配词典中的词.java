...
public class 基于权重的编辑距离从字符串中提取匹配词典中的词 {
    ...
    public static void main(String[] args) {
        ...
        DictionaryEntry<String> entry3 = new DictionaryEntry<String>("Mdm2","Mdm");
        ...
        WeightedEditDistance editDistance
            = new FixedWeightEditDistance(0,-1,-1,-1,Double.NaN);
              //0:matchWeight,-1:deleteWeight,-1: insertWeight,
              //-1:substituteWeight,Double.NaN:transposeWeight
        ...
        String texts[]={"Mdm2,p53, also known as protein 5 (TP53), functions as a tumor supressor."};
