...
public class 查询的拼写检查 {

    private static final File MODEL_FILE = new File("SpellCheck.model");
    private static final int NGRAM_LENGTH = 5;
    static final File DATA = new File("E:/JAVAProjects/lingpipe-4.1.0/demos/data/rec.sport.hockey/train");
    ...
    public static void main(String[] args)
        ...
        IndexWriter luceneIndexWriter = new IndexWriter(fsDir,ANALYZER,IndexWriter.MaxFieldLength.LIMITED);
    ...
    private static void testModelLoop(SpellChecker sc,IndexSearcher searcher)
