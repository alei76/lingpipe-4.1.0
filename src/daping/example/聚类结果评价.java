...
public class 聚类结果评价 {
    ...
    static void demoBasicScoring() {
        ...
        Set<Set<String>> referencePartition = new HashSet<Set<String>>();//标准结果
        ...
        HashSet<Set<String>> responsePartition = new HashSet<Set<String>>();//自己的结果
        ...
        //Traditional Clustering Measures:measured over whether they put pairs of elements (a,b) in the same cluster or not
        //■True Positives: same cluster in reference, same cluster in response
        //■False Negatives: same cluster in reference, different cluster in response
        //■False Positives: different cluster in reference, same cluster in response
        //■True Negatives: different cluster in reference, different cluster in response
