...
public class Partial二元TokenSvd {


    public static void main(String[] args) throws Exception {
        System.out.println("TokenBigramSVD");

        File textFile = new File("E:/JAVAProjects/lingpipe-4.1.0/demos/data/Pride and Prejudice.txt");
        ...
        SvdMatrix matrix
        	...
        	二元TokenSvd.reportSvd(values,matrix,symbolTable);
    }
