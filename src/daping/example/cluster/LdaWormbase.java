package daping.example.cluster;
...
public class LdaWormbase {
    ...
    public static void main(String[] args) throws Exception {
    	...
    	File corpusFile = new File("E:/JAVAProjects/lingpipe-4.1.0/demos/data/lda/questionNeed.txt");
        int minTokenCount = 5;
        short numTopics = 50;
        double topicPrior = 0.1; //一般取用50除以topic数
        double wordPrior = 0.01;
        int burninEpochs = 0;
        int sampleLag = 1;
        int numSamples = 200; //采样次数
