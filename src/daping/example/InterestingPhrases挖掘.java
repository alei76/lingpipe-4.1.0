...
public class InterestingPhrases挖掘 {
    ...
    private static File BACKGROUND_DIR 
        = new File("E:/JAVAProjects/lingpipe-4.1.0/demos/data/rec.sport.hockey/train");
    private static File FOREGROUND_DIR 
        = new File("E:/JAVAProjects/lingpipe-4.1.0/demos/data/rec.sport.hockey/test");
    ...
    public static void main(String[] args) throws IOException {
        ...
        report(coll);  //输出训练集中的InterestingPhrases：
        ...
        report(newTerms);//Finding New Terms in Comparison with Another Data Set
