...
public class 基于Cosine的文档聚类 {

    public static void main(String[] args) throws Exception {
        //File dir = new File("E:/JAVAProjects/lingpipe-4.1.0/demos/data/johnSmith");
       File dir = new File("E:/JAVAProjects/lingpipe-4.1.0/demos/data/fourNewsGroups/4news-test");
    	//File dir = new File("E:/JAVAProjects/lingpipe-4.1.0/demos/data/fourNewsGroups/4news-train");
        ...
        for (int k = 1; k <= docSet.size(); ++k) {
            ...
            //System.out.println(scoreCL.truePositives());
    ...
    static class Document {
        ...
        static double length(ObjectToCounterMap<String> otc) {//使用了归一化
            double sum = 0.0;
